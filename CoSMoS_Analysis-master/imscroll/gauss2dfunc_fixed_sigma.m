function pc=gauss2dfunc(inarg,xdata,sigma)
%
...
% inarg  == [ amp centerx centery offset]
...
pc= inarg(1)*exp( -( (xdata(:,:,1)-inarg(2)).^2/(2*sigma^2)+(xdata(:,:,2)-inarg(3)).^2/(2*sigma^2) )  )+inarg(4);