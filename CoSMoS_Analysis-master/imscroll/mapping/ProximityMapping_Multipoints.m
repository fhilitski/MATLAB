function pc=ProximityMapping_Multipoints(xy,fitparmvector,mappingpoints,OutputField)
%
%function  ProximityMapping_Multipoints(x2y2,fitparmvector,mappingpoints,OutputField)
%
...
for indx=1:rosenow
    ...
    mappednow(indx,:)=proximity_mapping_v1(mappingpoints,nowpts(indx,:),15,fitparmvector,OutputField);
end
