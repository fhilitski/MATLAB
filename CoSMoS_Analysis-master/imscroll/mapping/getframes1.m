function pc=getframes1(dum1,images1,folder1,handles,parenthandles)
%
% function getframes(dum,images,folder,range,choice)
%
...
elseif get(handles.ImageSource1,'Value') ==3     % pupup menu 'Glimpse_Folder'
     ...
     for aveindx=imagenum1:imagenum1+ave1-1         % Read in the frames and average them
        ...
        dum1=imadd(dum1,uint32( glimpse_image(parenthandles.gfolder,parenthandles.gheader,aveindx) ) );
    end
end
