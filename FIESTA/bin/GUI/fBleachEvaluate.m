...
if strcmp(get(hBleachEvaluate.fig,'SelectionType'),'normal')
    ...
    line([cp(1) cp(1)],xy{2},'Color','r','LineStyle','-','Tag','Selected');
    setappdata(0,'hBleachEvaluate',hBleachEvaluate);      
end
