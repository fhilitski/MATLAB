...
if isempty(h)
    ...
    hDataGui.tName = uicontrol('Parent',hDataGui.fig,'Units','normalized','FontSize',10,'FontWeight','bold',...
                              'HorizontalAlignment','left','Position',[0.025 0.96 0.2 0.02],...
    ...
    hDataGui.tFile = uicontrol('Parent',hDataGui.fig,'Units','normalized','FontSize',10,'FontAngle','italic',...
                              'HorizontalAlignment','left','Position',[0.25 0.96 0.5 0.02],...
...
if ~isempty(Object.PathData)
    ...
    lXaxis.data{n}=real(Object.PathData(:,3));
    lXaxis.units{n}='[nm]';
    n=n+1;
end
...
if ~isempty(Object.PathData)
    ...
    lYaxis(2).data{n}=real(Object.PathData(:,3));
    lYaxis(2).units{n}='[nm]';
...
n=n+2;
if strcmp(Type,'Molecule')==1
    if isfield(Object,'Data') && ~isempty(Object.Data)
        lYaxis(2).list{n}='z-position';
        lYaxis(2).data{n}=Object.Data;        
        lYaxis(2).units{n}='[nm]'; 
        n=n+1;
    end
